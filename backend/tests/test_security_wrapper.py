...
def test_is_suspicious_request_detects_sql_injection():
    ...
    event = {"queryStringParameters": {"id": "1 OR 1=1; DROP TABLE users--"}}
...
def test_is_suspicious_request_allows_normal_requests():
    ...
    event = {
        "path": "/api/form",
        "queryStringParameters": {"name": "test", "value": "123"},
    }
...
def test_secure_handler_blocks_suspicious_requests():
    ...
    suspicious_event = {"path": "/api/../../../etc/passwd"}
...
def test_secure_handler_ensures_body_is_string():
    ...
    @secure_handler
    def test_handler(event, context):
        return {"statusCode": 200, "body": {"message": "OK", "data": [1, 2, 3]}}
